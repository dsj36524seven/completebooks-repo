 ...
 * @since 20190305
 */
public class WordToolAct02 {

    WordToolAct02() {};

    /**
     * <h2>wordCount</h2>
     * <p>returns the total amount of words in a text, takes a string as parameter</p>
     *
     * @param s
     * @return int
     */
    ...
    /**
     * <h2>getFrequency</h2>
     * returns the count of occurrences of a symbol in a string
     *
     * @param s
     * @param c
     * @return int
    ...
    public static void main(String[] args) {
        WordToolAct02 wt = new WordToolAct02();

...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // integers1 equals integers3
        boolean is13 = Arrays.equals(integers1, 1, integers1.length, integers3, 1, integers3.length);
        System.out.println("integers 1 equal integers 3 between indexes [1 -> arrLength] ? " + is13);

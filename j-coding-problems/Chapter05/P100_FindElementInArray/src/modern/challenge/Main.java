...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // array of numbers                
        int[] numbers = new int[]{4, 5, 1, 3, 7, 4, 1, 5, 2, 8};
        ...
        boolean found1 = ArraySearch.containsElementV1(numbers.clone(), 7);
        ...
        boolean found2 = ArraySearch.containsElementV2(numbers.clone(), 7);
        ...
        boolean found3 = ArraySearch.containsElementV3(numbers.clone(), 7);

...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final long HOUSTON_DELAY_MS = 30000L; // delay 30s
        ...
        TrainDelay trainToHouston
                = new TrainDelay(UUID.randomUUID().toString(), "Houston", HOUSTON_DELAY_MS);

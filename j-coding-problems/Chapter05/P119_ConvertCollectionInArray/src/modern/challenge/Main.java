...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Converting Collection to array[] (Object[]): " + Arrays.toString(namesArrayAsObjects));
        ...
        System.out.println("--- returned String [] - no computation of array size ---");
        System.out.println(" ****************** ");

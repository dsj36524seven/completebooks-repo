...
public class Main {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
        ...
        // test what occurs when executed more than once
        String dbJdbcUrl = map1.computeIfPresent("mysql", jdbcUrl1);
        //String dbJdbcUrl = map1.computeIfPresent("notFoundDB", jdbcUrl1);
        if(dbJdbcUrl == null) {
            System.out.println("Key not found Map remains unchanged " + map1);
        } else {
            System.out.println("map modified as computeIfPresent() found key NOT INTENT !!! : \n" + map1);
        }
        ...
        map2.put("oracle", "jdbc:ora://192.172.0.72/customers_db");
        ...
        System.out.println();
        System.out.println("--------------------");
        String tryAgain = map2.computeIfAbsent("mongodb", jdbcUrl2);
        if(tryAgain != null) {
            System.out.println("map 2 not changed as key & value exists");
        }
        ...
        String oracleJdbcUrl = map3.compute("oracle", jdbcUrl3);

        System.out.println("MySQL JDBC URL: " + mysqlJdbcUrl);
        System.out.println("Derby JDBC URL: " + derbyJdbcUrl);
        System.out.println("Oracle JDBC URL: " + oracleJdbcUrl);

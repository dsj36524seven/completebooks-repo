...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("today's date and time :"+ ldt);
        System.out.println("first day of month would be :  "+ ldt.with(TemporalAdjusters.firstDayOfMonth()));
        System.out.println("last day of month would be :  "+ ldt.with(TemporalAdjusters.lastDayOfMonth()));

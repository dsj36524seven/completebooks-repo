...
public class Main {
    ...
    public static void main(String[] args) {              
        ...
        Date dateAfterAddingMinutes = DateTimes.addOrSubtractMinutes(date, 20);
        Date dateAfterSubtractingMinutes = DateTimes.addOrSubtractMinutes(date, -20);
        System.out.println("\nBefore adding 20 minutes: " + date
                + "\nAfter adding 20 minutes: " + dateAfterAddingMinutes
                + "\nAfter subtracting 20 minutes: " + dateAfterSubtractingMinutes);

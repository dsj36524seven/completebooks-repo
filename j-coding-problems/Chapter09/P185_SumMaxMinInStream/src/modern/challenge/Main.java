...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Optional - Max1: " + max1);
        System.out.println("Reduce orElse - Max2: " + max2);
        ...
        System.out.println("Optional - Min1: " + min1);
        System.out.println("Reduce orElse - Min2: " + min2);
        ...
        System.out.println("reduce() - Product: " + total3);
        ...
        System.out.println("reduce() orElseThrow() - Harmonic mean: " + hm);
    }

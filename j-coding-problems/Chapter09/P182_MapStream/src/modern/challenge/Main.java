...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Stream<Melon[]> streamOfMelonsArray2 = Arrays.stream(melonsArray);
        List<Melon> distinctMelons2 = streamOfMelonsArray2
                .skip(2) // execute before flatmap !!!
                .flatMap(Arrays::stream)
                .distinct()
                .collect(Collectors.toList());

        System.out.println("Distinct melons 2: " + distinctMelons2);

...
public class Main {
    ...
    public static void main(String[] args) 
        ...
        System.out.println("Car class has " + clazzConstructors.length + " constructors");
        ...
        Object instance = constructor.newInstance(new FileInputStream(Path.of("/home/dsj24seven/devWrkshp/JavaCodingProblems/Java-Coding-Problems-master/Chapter07/P151_InstantiateViaReflectedConstructor/test.txt").toFile()));

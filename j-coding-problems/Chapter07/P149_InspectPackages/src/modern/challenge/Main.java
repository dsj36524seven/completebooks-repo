...
public class Main {
    ...
    public static void main(String[] args) 
        ...
        logger.info("Get the classes of the specified package");
        // permission issues ... working example below
//      List<Class<?>> classes1 = Packages.fetchClassesFromPackage("org.apache.commons.lang3.builder");
        List<Class<?>> classes1 = Packages.fetchClassesFromPackage("modern.challenge");
        ...
        // at least no exception , but returns empty array
        // URL[] urls = Packages.fetchJarsUrlsFromClasspath(Path.of("/home/dsj24seven/node_modules"));

        URL[] urls = Packages.fetchJarsUrlsFromClasspath(Path.of("/usr/share/java")); // finally some jars returned

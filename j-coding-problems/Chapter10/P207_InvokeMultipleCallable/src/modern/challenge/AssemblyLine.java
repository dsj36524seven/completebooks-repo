...
public final class AssemblyLine {
    ...
    private static void startConsumers() {
        ...
        try {
            ...
            // do not wait for all futures to complete just the fastest one is returned
//            String bulbDontWait = consumerService.invokeAny(tasks);
//            int queueSize = queue.size();
//            List<Future<String>> futuresDontWait = new ArrayList<>();
//            for (int i =0; i < queueSize; i++) {
//                futuresDontWait.add(consumerService.submit(consumer));
//            }
//            for (Future<String> future: futuresDontWait) {

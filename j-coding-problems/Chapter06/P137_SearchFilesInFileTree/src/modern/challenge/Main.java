...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path startPath = Paths.get("/home/dsj24seven/Documents");

        try(Stream<Path> allFiles = Files.list(startPath)) {
            System.out.println("List the files from the current Folder, single level deep: ");
        ...
        System.out.println();
        System.out.println("\n\nFind all directories created after 16 March 2023: ");
        Stream<Path> resultAsStream3
                = Files.find(
                        ...
                        && attr.creationTime().toInstant().
                                isAfter(LocalDate.of(2023, 3, 16).atStartOfDay().
        ...
        //Stream<Path> resultAsStream4 = fetchFilesMatching(startPath, "glob:**/*.class");

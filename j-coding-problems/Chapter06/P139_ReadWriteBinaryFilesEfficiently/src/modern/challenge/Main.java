...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Files.newInputStream() method supports Path directly !!
        System.out.println("\n\n-------------------------------------------------------");
        try (BufferedInputStream bis = new BufferedInputStream(
    ...
    // prone to OOM outOfMemory errors
        ...
        // for very large files traverse the buffer with a fixed size
        final int MAP_SIZE = 5242880;
        try(FileChannel fileChannel =
                    FileChannel.open(binaryFile, StandardOpenOption.READ))
        {
            int pos = 0;
            ...
            while(pos < length) {
                ...
                MappedByteBuffer mappedByteBuffer = fileChannel.map(
                        FileChannel.MapMode.READ_ONLY, pos, bytesToMap);

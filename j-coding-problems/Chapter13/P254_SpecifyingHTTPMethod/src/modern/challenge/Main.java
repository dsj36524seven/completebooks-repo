...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        HttpRequest.Builder templateBuilder = HttpRequest.newBuilder()
                .uri(URI.create("https://reqres.in/api/users/2"));


        HttpRequest req1 = templateBuilder.copy().setHeader("Content-Type", "application/json").build();
        HttpResponse<String> req1Response = client.send(req1, HttpResponse.BodyHandlers.ofString());

        System.out.println("TemplateBuilder status code : " + req1Response.statusCode());
        System.out.println("TemplateBuilder body : " + req1Response.body());
    }
}

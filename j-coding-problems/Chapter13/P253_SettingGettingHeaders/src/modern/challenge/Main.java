...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Optional<String> valueOfXAuth = response.headers().firstValue("X-Auth");
        System.out.println("Value of X-Auth: " + valueOfXAuth);

        List<String> valueOfXAuth2 = response.headers().allValues("X-Auth");
        System.out.println("Value of X-Auth: " + valueOfXAuth2);
    }

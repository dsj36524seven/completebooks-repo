    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        HttpRequest requestBodyOfString = HttpRequest.newBuilder()
                ...
                .POST(HttpRequest.BodyPublishers.ofString(
                        "{\"name\": \"morpheus\",\"job\": \"leader\"}", Charset.defaultCharset()))
        ...
        HttpRequest requestBodyOfInputStream = HttpRequest.newBuilder()
                .header("Content-Type", "application/json")
                .POST(HttpRequest.BodyPublishers.ofInputStream(() -> inputStream("/home/dsj24seven/devWrkshp/JavaCodingProblems/Java-Coding-Problems-master/Chapter13/P255_SettingRequestBody/user.json")))
                .uri(URI.create("https://reqres.in/api/users"))
                .build();
        ...
        // BodyPublishers.ofByteArray() - create a byte array body
        HttpRequest requestBodyOfByteArray = HttpRequest.newBuilder()
                .header("Content-Type", "application/json")
                .POST(HttpRequest.BodyPublishers.ofByteArray(Files.readAllBytes(Path.of("/home/dsj24seven/devWrkshp/JavaCodingProblems/Java-Coding-Problems-master/Chapter13/P255_SettingRequestBody/user.json"))))
                .uri(URI.create("https://reqres.in/api/users"))
                .build();
        ...
        HttpRequest requestBodyOfFile = HttpRequest.newBuilder()
                .header("Content-Type", "application/json")
                .POST(HttpRequest.BodyPublishers.ofFile(Path.of("/home/dsj24seven/devWrkshp/JavaCodingProblems/Java-Coding-Problems-master/Chapter13/P255_SettingRequestBody/user.json")))
                .uri(URI.create("https://reqres.in/api/users"))
                .build();
